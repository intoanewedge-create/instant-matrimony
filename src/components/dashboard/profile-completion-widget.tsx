    ...
    >
      ...
      <div className="px-5 py-4 border-b" style={{ borderColor: "#F3F4F6" }}>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-sm font-bold" style={{ color: "#00A76F" }}>
            {completionPercent}%
          </span>
        </div>
        <div
      ...
      <div className="p-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
        {cards.map(
          ({ icon: Icon, title, desc, href, done, doneLabel, testId }) =>
            done ? (
              <div
                key={title}
              ...
              >
                ...
                <p className="text-[11px] pl-9" style={{ color: "#6B7280" }}>
                  {desc}
                </p>
              </Link>
            ),
