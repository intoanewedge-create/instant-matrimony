                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="space-y-1 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded bg-rose-950/60 text-rose-400 border border-rose-900/50">
                          {faq.category}
                        </span>
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      >
                        {faq.isActive ? <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" /> : <XCircle className="w-3.5 h-3.5 text-slate-500" />}
                      </Button>
                      <Button
                        variant="ghost"
                        size="sm"
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-100">Delete FAQ</h3>
                <p className="text-xs text-slate-400 mt-0.5">Are you sure you want to permanently delete this FAQ?</p>
              </div>
            </div>

            <div className="p-3 bg-slate-950/60 border border-slate-800/80 rounded-lg text-xs space-y-1">
              <p className="font-semibold text-slate-200">{deletingFaq.question}</p>
