    ...
    <div className="container mx-auto px-4 py-8 space-y-8 text-slate-900">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-rose-50 border border-rose-200 text-rose-700 text-xs font-bold shadow-xs">
          ...
          <span>{pagination.totalRecords} Live Matches Found</span>
        </div>
      </div>
      ...
      <div className={`grid grid-cols-1 lg:grid-cols-4 gap-8 ${searchMode === 'profileId' ? 'lg:grid-cols-1' : ''}`}>
        {/* Filters Sidebar with Collapsible Accordions */}
        {searchMode === 'criteria' && (
          <Card className="border border-slate-200 bg-white shadow-sm h-fit lg:col-span-1 overflow-hidden rounded-2xl">
            <CardHeader className="border-b border-slate-100 pb-3">
              <CardTitle className="text-base font-bold flex items-center justify-between text-rose-600">
                <div className="flex items-center gap-2">
                  <SlidersHorizontal className="w-4 h-4" /> Filter Criteria
                </div>
                <span className="text-[10px] font-semibold bg-rose-50 text-rose-700 px-2 py-0.5 rounded-full border border-rose-200">
                  {pagination.totalRecords} Matches
                </span>
              </CardTitle>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                ...
                <div className="border border-slate-200 rounded-xl overflow-hidden bg-slate-50/50">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 text-xs font-bold text-slate-800 hover:bg-slate-100/70 transition-colors"
                  >
                    <span>Basic & Demographic</span>
                    {openAccordions.basic ? <ChevronUp className="w-3.5 h-3.5 text-slate-500" /> : <ChevronDown className="w-3.5 h-3.5 text-slate-500" />}
                  </button>
                    ...
                    <div className="p-3 bg-white border-t border-slate-200 space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <Input type="number" placeholder="Min 18" {...register("minAge")} className="h-8 text-xs border-slate-200 bg-slate-50 text-slate-900 focus-visible:ring-rose-500 rounded-lg" />
                          <Input type="number" placeholder="Max 60" {...register("maxAge")} className="h-8 text-xs border-slate-200 bg-slate-50 text-slate-900 focus-visible:ring-rose-500 rounded-lg" />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <Input type="number" placeholder="Min 140" {...register("minHeight")} className="h-8 text-xs border-slate-200 bg-slate-50 text-slate-900 focus-visible:ring-rose-500 rounded-lg" />
                          <Input type="number" placeholder="Max 210" {...register("maxHeight")} className="h-8 text-xs border-slate-200 bg-slate-50 text-slate-900 focus-visible:ring-rose-500 rounded-lg" />
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="border border-slate-200 rounded-xl overflow-hidden bg-slate-50/50">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 text-xs font-bold text-slate-800 hover:bg-slate-100/70 transition-colors"
                  >
                    <span>Religious & Community</span>
                    {openAccordions.religious ? <ChevronUp className="w-3.5 h-3.5 text-slate-500" /> : <ChevronDown className="w-3.5 h-3.5 text-slate-500" />}
                  </button>
                  {openAccordions.religious && (
                    <div className="p-3 bg-white border-t border-slate-200 space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <select {...register("religion")} className="w-full h-8 px-2 border border-slate-200 bg-slate-50 rounded-lg text-xs text-slate-900 focus:bg-white focus:outline-none focus:border-rose-500">
                ...
                {/* ACCORDION 3: Professional & Location */}
                <div className="border border-slate-200 rounded-xl overflow-hidden bg-slate-50/50">
                  <button
                    type="button"
                  ...
                  >
                    ...
                    {openAccordions.professional ? <ChevronUp className="w-3.5 h-3.5 text-slate-500" /> : <ChevronDown className="w-3.5 h-3.5 text-slate-500" />}
                  </button>
                  {openAccordions.professional && (
                    <div className="p-3 bg-white border-t border-slate-200 space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <Input placeholder="e.g. Hyderabad" {...register("city")} className="h-8 text-xs border-slate-200 bg-slate-50 text-slate-900 focus-visible:ring-rose-500 rounded-lg" />
                      </div>
                    </div>
                  )}
                </div>

                {/* ACCORDION 4: Lifestyle & Verification */}
                <div className="border border-slate-200 rounded-xl overflow-hidden bg-slate-50/50">
                  <button
                    type="button"
                    ...
                    className="w-full flex items-center justify-between p-3 text-xs font-bold text-slate-800 hover:bg-slate-100/70 transition-colors"
                  >
                    <span>Lifestyle & Verification</span>
                    {openAccordions.lifestyle ? <ChevronUp className="w-3.5 h-3.5 text-slate-500" /> : <ChevronDown className="w-3.5 h-3.5 text-slate-500" />}
                  </button>
