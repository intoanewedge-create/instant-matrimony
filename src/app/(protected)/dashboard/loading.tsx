    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl space-y-8 animate-pulse text-slate-400">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-2">
          ...
          <div className="h-4 w-80 bg-slate-850 rounded" />
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <Card key={i} className="border border-slate-850 bg-slate-900/30 p-5 rounded-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[1, 2, 3, 4].map((i) => (
              <Card key={i} className="border border-slate-850 bg-slate-900/30 rounded-2xl overflow-hidden">
                <div className="aspect-[4/3] bg-slate-850" />
                <CardContent className="p-4 space-y-2">
                  <div className="h-5 w-32 bg-slate-800 rounded" />
                  <div className="h-4 w-44 bg-slate-850 rounded" />
        ...
        <div className="space-y-4">
          ...
          <Card className="border border-slate-850 bg-slate-900/30 p-5 rounded-2xl space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
